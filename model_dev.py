...
# 'particular_account', 'particular_plus_account', are new registered which can be ignored.
fre_des(y)
y = y[['current_accounts', 'payroll_account', 'short_term_deposits',
       'long_term_deposits', 'e_account', 'funds', 'taxes',
...
parameters = {'k': range(2, 3), 's': [0.5, 0.7, 1.0]}
score = 'f1_macro'
clf_knn = GridSearchCV(MLkNN(), parameters, scoring=score)
clf_knn.fit(x_train.iloc[:10000, :].values, y_train.iloc[:10000, :].values)
